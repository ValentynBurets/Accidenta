...
public record GetAllContactsQuery(int Page = 1, int PageSize = 10);

public class GetAllContactsQueryHandler : IQueryHandler<GetAllContactsQuery, PagedResult<ContactDto>>
{
